...
class net(nn.Module):
    def __init__(self, FLAGS):
        ...
        # ISF
        # self.d_ISF = ISF(channels=C, r=4)
        # self.t_ISF = ISF(channels=C, r=4)
    ...
    def forward(self, x, y):
        ...
        # ISF BCL
        # d = self.d_ISF(x_embedding, y_embedding)
        # t = self.t_ISF(y_embedding, x_embedding)
        d = x_embedding
        t = y_embedding
        # RegNet BCL
        out = self.regnet(d, t)
